<!-- Start Footer.php -->
  ...
  <div class="row">
    ...
    <div class="col-6 col-lg-3 social-links">
      <h3><?php _e('Follow us','teejakohv') ?></h3>

      <a href="https://www.facebook.com/TEEjaKOHV/" class="facebook text-light" target="_blank">
  ...
  <p class="text-success developers-link"><small><?php bloginfo('name'); ?> <?php echo date('Y'); ?> @ <a class="developers-link" href="www.iweb.ee" target="_blank">iweb.ee</a></small></p>
</div>
