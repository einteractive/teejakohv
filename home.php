          ...
          <article class="post clearfix">
            <?php
              ...
              <p><em>
	              ...
	              <?php echo the_date('d-m-Y');?> / <?php the_author(); ?><br>
...
<a href="<?php the_permalink(); ?>" class="btn btn-outline-success pull-right" role="button" aria-pressed="true"><?php _e('Read more','woocommerce') ?> <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
